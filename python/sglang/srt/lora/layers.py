...
class FusedMoEWithLoRA(BaseLayerWithLoRA):
    ...
    def _get_lora_info(self):
        ...
        wi = batch_info.req_weight_indices if batch_info.req_weight_indices is not None else batch_info.weight_indices
        ...
        seg_indptr = batch_info.req_seg_indptr if batch_info.req_seg_indptr is not None else batch_info.seg_indptr
        req_to_lora = wi
